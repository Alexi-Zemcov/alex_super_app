...
построенное на Dart Workspaces.
...
<!-- TODO: добавить ссылки на  /  /  -->

[GitHub](https://github.com/Alexi-Zemcov)
[Telegram](https://t.me/AlexeyZemcov)
[LinkedIn](https://www.linkedin.com/in/alexey-zemtsov/)
[Сетка](https://setka.ru/users/019caf76-f511-7a11-9a39-0f0a217427d5)
...
> Референс UI/UX - [Дром ПДД](https://play.google.com/store/apps/details?id=ru.drom.pdd.android.app&hl=ru).
...
> Референс UI/UX - [Circle Of Fifths](https://play.google.com/store/apps/details?id=com.joshliebe.circleoffifths).
...
- Сейчас звук не воспроизводится на Web и Desktop. Планирются исправления для этих платформ.
